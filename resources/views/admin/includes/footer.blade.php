<footer class="footer">
  ...
  <script src="{{asset('admin_panel/assets/js/core/bootstrap-material-design.min.js')}}"></script>
  ...
  <!-- Chartist JS -->
  <script src="{{asset('admin_panel/assets/js/plugins/chartist.min.js')}}"></script>
  <!--  Notifications Plugin    -->
  <script src="{{asset('admin_panel/assets/js/plugins/bootstrap-notify.js')}}"></script>
  <!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc -->
  <script src="{{asset('admin_panel/assets/js/material-dashboard.js?v=2.1.0')}}"></script>
