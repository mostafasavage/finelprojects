...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title" style="color:#fff;">Page Update  Prodect
            ...
            <div class="card-body">
                <form action="{{route('prod.update' , $prod->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="number" name="cat_id" class="form-control" value="{{$prod->cat_id}}">
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-12 mb-3">
                    <button type="submit" class="btn btn-primary">Update Prodect</button>
                    </div>                                                                                    
                    </div>
                    </form>
            </div>
